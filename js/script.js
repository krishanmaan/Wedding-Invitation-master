...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='container'><div class='days block'>"+ days + "<span>Days</span></div>" + "<div class='hours block'>" + hours + "<span>Hours</span></div>" + "<div class='minutes block'>" + minutes + "<span>Minutes</span></div>" + "<div class='seconds block'>" + seconds + "<span>Seconds</span></div></div>";
...
console.log('\n\n%c SAVE THE DATE: 25th April, 2026!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Papatwan Family', styles1, styles2);
